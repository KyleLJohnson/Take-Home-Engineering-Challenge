...
<ol>
  ...
  <li>Download <a href='https://cseboulderinterview.blob.core.windows.net/triprecord/tripdata.zip'>Jan 2018 data</a> and extract them into the application folder. The data CSV files need to be in the same folder as the Python file.</li>
